...
|3| Arguably | Adverb | Problably, perhaps, maybe,etc   |
...
|7| Avian| Adjective| This word is used to talk about something relatif to birds | 
...
| Article | Words from the text | Functions   |  Synonym/explanation in English |
| --------- | ---------- | ------------|------------- |
|4| pollen basket or corbicula| Noun | a cavity where the pollen is stocked ,surrounded by setae |
![](image/honeybee_hindleg.jpg)

| Article | Words from the text | Functions   |  Synonym/explanation in English |
| --------- | ---------- | ------------|------------- |
|6| A beak| Noun | A  piece of the anatomy used to break the food like for birds|
...
|5| To (mind-)blow | Verb | To impress |
